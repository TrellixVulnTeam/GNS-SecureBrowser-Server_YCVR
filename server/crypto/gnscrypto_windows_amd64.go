...
// #cgo CFLAGS: -I../../gnscryptocpp
// #cgo LDFLAGS: -lgnscrypto -lstdc++ C:/msys64/mingw64/lib/libz.a C:/msys64/mingw64/lib/libcrypto.a C:/msys64/mingw64/lib/libssl.a -lws2_32
...
// requires libwinpthread-1.dll, libgcc_s_seh-1.dll, and libstdc++-6.dll   since I cant do static link to libstdc++
// LDFLAGS: -L../../win_build/gnscrypto/lib -lgnscrypto -l:libz.a -l:libcrypto.a -l:libssl.a -lws2_32 -lstdc++
...
func GenerateChallenge() ([]byte, string) {
	...
	challenge_len := C.ulonglong(256)
	digest_len := C.ulonglong(64)
...
func SignChallenge(challenge []byte, cert_name string) string {
	...
	C.sign_challenge((*C.uchar)(unsafe.Pointer(&challenge[0])), C.ulonglong(len(challenge)), name, (*C.char)(r), (*C.char)(s), (C.bool)(false))
