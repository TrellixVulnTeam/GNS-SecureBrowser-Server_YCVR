...
// #cgo LDFLAGS: -L../../linux_build/gnscrypto/lib -lgnscrypto -l:libz.a -l:libcrypto.a -l:libssl.a -ldl -lstdc++
...
func GenerateChallenge() ([]byte, string) {
	...
	challenge_len := C.uint(256)
	digest_len := C.uint(64)
...
func SignChallenge(challenge []byte, cert_name string) string {
	...
	C.sign_challenge((*C.uchar)(unsafe.Pointer(&challenge[0])), C.uint(len(challenge)), name, (*C.char)(r), (*C.char)(s), (C.bool)(false))
